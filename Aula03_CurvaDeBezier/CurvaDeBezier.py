...
# Função para criar e plotar um ponto na posição clicada
...
def plot_bezier_curve(renderer, control_points):
    ...
    # Criar uma polyline para conectar os pontos da curva
    polyline = vtk.vtkPolyLine()
    polyline.GetPointIds().SetNumberOfIds(bezier_points.GetNumberOfPoints())
    for i in range(bezier_points.GetNumberOfPoints()):
